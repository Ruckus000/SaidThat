...
export const s = StyleSheet.create({
  ...
  beacon: { borderTopWidth: 4, borderBottomWidth: 4, borderColor: c.marigold, paddingVertical: 8 },
  game: { color: c.textPrimary, fontFamily: display, fontSize: 12, fontWeight: "800", letterSpacing: 1, textAlign: "center" },
  cardFill: { flex: 1 },
